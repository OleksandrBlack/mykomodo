      ...
      <Container>      
        <Row>
          <Col>                          
            ...
            <ul>
              <li><span className="guide1b">Go to</span> <a href="https://wallet.safecoin.org">https://wallet.safecoin.org</a></li>
            ...
            <ul>
              <li><span className="guide2b">If you've created a wallet on</span> <a href="https://wallet.safecoin.org">https://wallet.safecoin.org</a> <span className="guide2c">via the secret phrase, simply re-enter the same phrase.</span></li>
